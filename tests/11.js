...
var resultOptions = [
    {   title: 'Ваш водный баланс в норме',
        desc: '<p>Чтобы сохранять водный баланс, узнайте о биологически доступной воде у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Есть вероятность обезвоживания организма',
        desc: '<p>Следует проанализировать свой питьевой режим по качеству и количеству, а также оптимизировать его. Выпивайте воду в сутки из расчета 30 мл на 1 кг веса. Чтобы узнать, что такое биологически доступная вода, которая поможет быстрее справиться с обезвоживанием - обратитесь к консльтанту через удобную вам форму связи.</p>'},
    {   title: 'Вы обезвожены',
        desc: '<p>Оптимизируйте свой питьевой режим. Выпивайте воды в сутки из расчета 30 мл на 1 кг веса. Чтобы узнать, что такое биологически доступная вода, которая поможет быстрее справиться с обезвоживанием - обратитесь к консльтанту через удобную вам форму связи.</p>'}
];
