...
var resultOptions = [
    {   title: 'Центральная нервная система функционирует в пределах нормы',
        desc: '<p>Для того, чтобы сохранить центральную нервную систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Центральная нервная система работает с нагрузкой',
    ...
    {   title: 'Центральная нервная система перегружена',
