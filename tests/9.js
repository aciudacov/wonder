...
var resultOptions = [
    {   title: 'Риск развития диабета минимальный',
        desc: '<p>Чтобы избежать риска возникновения диабета, узнайте о программах сохранения здоровья у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Риск развития диабета высокий',
        desc: '<p>Чтобы исключить факторы, ведущие к диабету, вы можете узнать о общей концепции здоровья у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Риск развития диабета очень высокий',
        desc: '<p>Чтобы исключить факторы, ведущие к диабету, вы можете узнать о общей концепции здоровья у консультанта через удобную вам форму связи.</p>'}
];
