...
var resultOptions = [
    {   title: 'Лимфатическая система функционирует в пределах нормы',
        desc: '<p>Чтобы сохранить лимфатическую систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Лимфатическая система работает с нагрузкой',
    ...
    {   title: 'Лимфатическая система перегружена',
