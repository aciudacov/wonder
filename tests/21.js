...
var resultOptions = [
    {   title: 'Выделительная система функционирует в пределах нормы',
        desc: '<p>Чтобы сохранить выделительную систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Выделительная система работает с нагрузкой',
    ...
    {   title: 'Выделительная система перегружена',
