...
var resultOptions = [
    {   title: 'Репродуктивная система функционирует в пределах нормы',
        desc: '<p>Чтобы сохранить репродуктивную систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Репродуктивная система работает с нагрузкой',
        desc: '<p>Это состояние требует повышенного внимания к ней. Также вы можете узнать о концепции сохранения и восстановления здоровья у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Репродуктивная система перегружена',
        desc: '<p>Если у вас отмечаются подобные жалобы, не надо откладывать процесс обследования. Репродуктивная система очень важна для мужчины. Любой из этих симптомов является началом опасного хронического процесса и чем раньше начнется восстановление, тем лучше. Параллельно с обследованием вы можете узнать о общей концепции сохранения и восстановления здоровья у консультанта через удобную вам форму связи.</p>'}
];
