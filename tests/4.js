...
var resultOptions = [
    {   title: 'Дыхательная система функционирует в пределах нормы',
        desc: '<p>Чтобы сохранить стабильное функционирование системы органов дыхания, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Дыхательная система работает с нагрузкой',
        desc: '<p>Это состояние требует повышенного внимания к ней. Также вы можете узнать о общей концепции здоровья. Чтобы узнать о концепции здоровья, выберите удобную вам форму связи.</p>'},
    {   title: 'Дыхательная система перегружена',
        desc: '<p>При наличии жалоб следует обратиться к врачу. Желательно изменить образ жизни. Рекомендуется дообследование, так как любой патологический процесс имеет причину.</p>'}
];
