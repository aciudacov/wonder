...
var resultOptions = [
    {   title: 'Система органов пищеварения функционирует в пределах нормы',
        desc: '<p>Для того, чтобы сохранить органы пищеварения вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Система органов пищеварения работает с нагрузкой',
        desc: 'Это состояние требует повышенного внимания к ней.',
        title : '<p>Также вы можете узнать о концепции сохранения и восстановления здоровья. Для того, чтобы узнать о концепции, обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Система органов пищеварения перегружена',
        desc: '<p>Желательно изменить образ жизни, пересмотреть свое питание. Рекомендуется дообследование, так как любой патологический процесс имеет причину. Параллельно с обследованием вы можете узнать о общей концепции здоровья. Чтобы узнать о концепции здоровья, выберите удобную вам форму связи.</p>'}
];
