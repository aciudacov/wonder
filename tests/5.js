...
var resultOptions = [
    {   title: 'Вероятность наличия у Вас грибковой инфекции минимальная',
        desc: '<p>Для профилактики и защиты вы можете узнать о антигрибковых программах у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Вероятность наличия у Вас грибковой инфекции значительная',
        desc: '<p>Вероятно, у Вас снижен иммунитет. Необходимо провести исследование на грибы (Candida и другие). Параллельно с исследованием вы можете узнать о антигрибковых программах у консультанта через удобную вам форму связи.</p>'},
    {   title: 'У Вас очень высока вероятность грибковой инфекции',
        desc: '<p>Необходимо выявить очаги этой инфекции и тип грибка. Это можно сделать в поликлиниках или лабораториях при инфекционных больницах. Необходимо укрепить иммунитет, изменить образ жизни, повысить противогрибковую защиту. Грибковая инфекция значительно осложняет течение всех хронических заболеваний, поэтому с ней надо бороться. Для подбора индивидуальной противогрибковой программы обратитесь к консультанту через удобную вам форму связи.</p>'}
];
