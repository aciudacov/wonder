...
var resultOptions = [
    {   title: 'Периферическая нервная система функционирует в пределах нормы',
        desc: '<p>Для того, чтобы сохранить периферическую нервную систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Периферическая нервная система работает с нагрузкой',
        desc: '<p>Это состояние требует повышенного внимания к ней. Для того, чтобы узнать о программах восстановления центральной нервной системы, обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Периферическая нервная система перегружена',
        desc: '<p>Измените образ жизни. Для того, чтобы узнать о программах восстановления центральной нервной системы, обратитесь к консультанту через удобную вам форму связи.</p>'}
];
