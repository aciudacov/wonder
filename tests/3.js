...
var resultOptions = [
    {   title: 'Ваша иммунная система достаточно стабильна',
        desc: '<p>Для того, чтобы сохранить стабильное функционирование иммунной системы, Вы можете узнать у консультанта о программах защиты данной системы. Обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Ваша иммунная система в опасности, хотя пока функционирует неплохо',
        desc: '<p>не переоценивайте своих возможностей. Не забывайте про здоровый образ жизни, употребляйте в пищу больше овощей и фруктов, богатых витаминами. Также вы можете узнать о концепции сохранения и восстановления здоровья. Обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Ваша иммунная система оставляет желать лучшего',
        desc: '<p>Вы можете помочь ей, основательно перестроить режим питания, добавив в пищу больше овощей и фруктов, увеличив продолжительность сна, отказавшись от алкоголя и табакокурения, и уделив внимание спорту - минимум 20 минут в день спортивных упражнений. Параллельно также вы можете узнать о концепции сохранения и восстановления здоровья. Обратитесь к консультанту через удобную вам форму связи.</p>'}
];
