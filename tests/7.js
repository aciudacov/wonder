...
var resultOptions = [
    {   title: 'Ваша печень в прекрасном состоянии',
        desc: '<p>Судя по всему, вы правильно питаетесь и ведете здоровый образ жизни. Чтобы способствовать нормальному фунционированию печени - узнайте о программах защиты у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Проявите повышенную заботу о печени',
        desc: '<p>Разгрузите ее хотя бы на 1-2 недели, придерживаясь обезжиренной диеты. Если вы употребляете алкогольные напитки - откажитесь от них. Пейте минеральную воду без газа (не менее 1,5 л в день), чтобы "вымыть" из организма токсины, посещайте баню 2-3 раза в неделю - банные процедуры очищают кожу, усиливают ее выделительную функцию и тем самым, разгружают печень. Чтобы спобоствовать нормальному фунционированию печени - узнайте о программах защиты у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Ваша печень не в порядке',
        desc: '<p>Сдайте биохимический анализ крови на печеночные ферменты (АЛТ, АСТ) и сделайте УЗИ печени.</p>'}
];
