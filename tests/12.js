...
var resultOptions = [
    {   title: 'Ваш организм не закислен',
        desc: '<p>Чтобы сохранять свое здоовье, узнайте о программах защиты своего организма у консультанта через удобную вам форму связи.</p>'},
    {   title: 'У Вас начальная степень закисления',
        desc: '<p>Обратите внимание на свое питание и напитки. Чтобы сохранять свое здоровье, узнайте о программах защиты своего организма у консультанта через удобную вам форму связи.</p>'},
    {   title: 'У Вас закисление организма',
        desc: '<p>Необходимо менять режим питания и напитков. Чтобы сохранять свое здоовье, узнайте о программах защиты своего организма у консультанта через удобную вам форму связи.</p>'},
    {   title: 'Вам необходимо срочно менять свой образ жизни',
        desc: '<p>У Вас выражена агрессия кислот, которая приведет к деминерализации организма, понижению активности ферментов и к нарушениям на клеточном уровне. Всё можно изменить. Чтобы избежать проблем со здоровьем, узнайте о концепции здоровья у консультанта через удобную вам форму связи.</p>'}
];
