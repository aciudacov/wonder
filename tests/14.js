...
var resultOptions = [
    {   title: 'Сердечно-сосудистая система функционирует в пределах нормы',
        desc: '<p>Для того, чтобы сохранить сердечно сосудистую систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Сердечно-сосудистая система работает с нагрузкой',
        desc: '<p>Это состояние требует повышенного внимания к ней. Также вы можете узнать о концепции сохранения здоровья. Чтобы узнать о концепции, обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Сердечно-сосудистая система перегружена',
        desc: '<p>При наличии жалоб обратитесь к врачу. Желательно изменить образ жизни. Рекомендуется обследование, так как любой патологический процесс имеет причину. Параллельно с обследованием вы можете узнать о общей концепции здоровья. Чтобы узнать о концепции здоровья, выберите удобную вам форму связи.</p>'}
];
