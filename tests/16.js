...
var resultOptions = [
    {   title: 'Костно-мышечная система функционирует в пределах нормы',
        desc: '<p>Для того, чтобы сохранить костно-мышечную систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Костно-мышечная система работает с нагрузкой',
        desc: '<p>Это состояние требует повышенного внимания к ней. Также вы можете узнать о концепции сохранения и восстановления здоровья. Чтобы узнать о концепции, обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Костно-мышечная система перегружена',
        desc: '<p>Могут быть начальные, либо сформированные патологические процессы. Желательно изменить образ жизни. Рекомендуется дообследование, так как любой патологический процесс имеет причину. Параллельно с обследованием вы можете узнать о общей концепции здоровья через удобную вам форму связи.</p>'}
];
