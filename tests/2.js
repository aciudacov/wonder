...
var resultOptions = [
    {   title: 'Вероятность присутствия вирусов в организме минимальна',
        desc: '<p>Чтобы сохранить свой иммунитет, обратитесь к консультанту, который подберет для вас программу защиты иммунитета. Выберите удобную вам форму связи.</p>'},
    {   title: 'У Вас вероятна вирусная инфекция',
        desc: '<p>Необходимо провести исследование крови на ДНК вирусов или антитела (ИФА). Паралельно с обследованием вы можете узнать о программах усиления иммунитета. Для этого обратитесь к консультанту через удобную вам форму связи.</p>'},
    {   title: 'Вам надо тщательно обследоваться',
        desc: '<p>Вы заражены вирусами. Вероятность пониженного иммунитета очень высока. Надо определить очаги хронической вирусной инфекции двумя методами (ИФА и ПЦР). Самое главное - определить наличие канцерогенных папилломовирусов программу, генитального герпеса и цитомегаловируса. Паралельно с обследованием вы можете узнать о программах усиления иммунитета. Для этого обратитесь к консультанту через удобную вам форму связи.</p>'}
];
