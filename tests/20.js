...
var resultOptions = [
    {   title: 'Эндокринная система функционирует в пределах нормы',
        desc: '<p>Чтобы сохранить эндокринную систему, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Эндокринная система работает с нагрузкой',
    ...
    {   title: 'Эндокринная система перегружена',
