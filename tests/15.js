...
var resultOptions = [
    {   title: 'Система органов кроветворения функционирует в пределах нормы',
        desc: '<p>Для того, чтобы сохранить систему органов кроветворения, вы можете узнать у консультанта о программах защиты данной системы через удобную вам форму связи.</p>'},
    {   title: 'Система органов кроветворения работает с нагрузкой',
    ...
    {   title: 'Система органов кроветворения перегружена',
        desc: '<p>Система органов кроветворения перегружена. Желательно изменить образ жизни. Рекомендуется дообследование, так как любой патологический процесс имеет причину. Параллельно с обследованием вы можете узнать о общей концепции здоровья через удобную вам форму связи.</p>'}
];
