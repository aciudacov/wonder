...
var resultOptions = [
    {   title: 'У вас все отлично',
        desc: '<p>Продолжайте в том же духе</p>'},
    ...
    {   title: 'You Are This One Thing',
        desc: '<p>Here, have an Archer</p>'},
    {   title: 'Вам конец',
        desc: '<p>Бронируйте место на кладбище</p>'}
];
    ...
    if (quizSteps.find('.active').length == quizSteps.length){
        ...
        while (n < numResults) {
            ...
            if (totalScore <= increment) {
                // populate results
                resultsTitle.replaceWith("<h1>" + resultOptions[n].title + " | your score is " + totalScore + " |</h1>");
